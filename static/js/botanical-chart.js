...
class BotanicalChart {
    ...
    render() {
        ...
        let html = `
            <div class="botanical-chart bg-gradient-to-br from-white via-amber-50/50 to-yellow-100/30 dark:from-yellow-600 dark:via-amber-800/70 dark:to-yellow-1000 rounded-lg shadow-md p-4 border border-amber-200/30 dark:border-amber-700/20">
                <div class="space-y-3">
        `;
